...
ScreenMap.prototype.DrawSprite = function(bctx, Entity){
     if(bctx != null && Entity != null){
		...
		if(!position) throw "";
			...
			window.alert("Entity:Incomplete definition, missing:" + err);
		}
		//-----------------------------------------Rendering Rules--------------------------------
		switch(EntType){
...
/**
* Function to test for a valid entity
* @param {Boolean} active boolean value indicating whether the debugger is active or not
* @param {Entity} entity A reference to the entity to test
* @param {Entity} varString the defined string to test 
*/
ScreenMap.prototype.Debugger = function(active, entity, varString){
}
