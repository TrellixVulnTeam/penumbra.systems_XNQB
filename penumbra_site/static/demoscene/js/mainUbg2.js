...
(function() {
	...
	var light, materials;
	scene.add( new THREE.AmbientLight( 0xFF00FF ) );
	light = new THREE.DirectionalLight( 0xffebff, 1.75 );
	...
	var cubeTexture = THREE.ImageUtils.loadTexture('/static/demoscene/img/cry.png');
