...
Stage.prototype.index = function(){
	...
	/*---------------------------------------------CATEGORY GROUPINGS------------------------------------------*/
	this.Backgrounds.push("space.png");
	//this.Backgrounds.push("Spinny.png");
	/*--------------------------------------Backgrounds--------------------------------------------------------*/
	this.ImageKeys.push("space.png");
	this.ImageData.push(new Array(this.ResourceRoot + 'img/pg1/space.png',800,600));
	//this.ImageKeys.push("Spinny.png");
	//this.ImageData.push(new Array(this.ResourceRoot + 'img/pg1/Spinny.png', 256, 256));
	/*------------------------------------Stage Menu Configuration---------------------------------------------*/
	this.DOMKeys.push("Text1");
	//Origin x, y, dimx, dimy, text, font
	this.DOMData.push(new Array(450, 50, 500, 25, "Magic Fighter", "44px Arial", "blue"));
	//this.DOMKeys.push("Text2");
	//Origin x, y, dimx, dimy, text, font
	//this.DOMData.push(new Array(200, 130, 900, 25, "(Magic Fighter)", "28px Arial", "blue"));
	//this.EntityKeys.push("Spinny");
	//this.EntityData.push(new Entity("Spinny", "Spinny", 50, 50, "widgets", "12345"));
}
...
Stage.prototype.page11 = function(){
	...
	this.DOMKeys.push("Text2");
	//Origin x, y, dimx, dimy, text, font
	this.DOMData.push(new Array(50, 300, 1100, 25, "Contact: the82professional@hotmail.com", "24px Verdana", "blue"));	
	this.DOMKeys.push("Text2");
	//Origin x, y, dimx, dimy, text, font
	this.DOMData.push(new Array(50, 350, 1100, 25, "Site URL: www.penumbra.systems", "24px Verdana", "blue"));	
	this.DOMKeys.push("Text2");
	//Origin x, y, dimx, dimy, text, font
	this.DOMData.push(new Array(50, 400, 1100, 25, "Informal Development Blog: formerly tvzdev.blogspot.com, Now on Website", "24px Verdana", "blue"));		
}
